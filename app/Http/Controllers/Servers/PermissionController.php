...
class PermissionController extends Controller
{
    ...
    public function store(StorePermissionRequest $request)
    {
        ...
        if ($this->permissionService->create()) {
            return redirect()->route('permissions.index')->with('toast_success', $successMessage);
        }

        return redirect()->route('permissions.create')->with('toast_error', $errorMessage);
    }
    ...
    public function update(UpdatePermissionRequest $request, $id)
    {
        ...
        if (empty($idPermission)) {
            return redirect()->route('permissions.index')->with('toast_error', $errorMessage);
        }
