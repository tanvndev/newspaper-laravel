...
!(function (i) {
    ...
    (MINIMALDOG.header = {
        init: function () {
            MINIMALDOG.header.ajaxSearch(),
                ...
                MINIMALDOG.header.stickyNavbarPadding();
        },
        stickyNavbarPadding: function () {
            i(window).load(function () {
                var n = i.fn.modal.Constructor.prototype.setScrollbar;
                i.fn.modal.Constructor.prototype.setScrollbar = function () {
                    n.apply(this),
                        this.bodyIsOverflowing &&
                            this.scrollbarWidth &&
                            i(".sticky-header .navigation-bar").css(
                                "padding-right",
                                this.scrollbarWidth
                            );
                };
                var e = i.fn.modal.Constructor.prototype.resetScrollbar;
                i.fn.modal.Constructor.prototype.resetScrollbar = function () {
                    e.apply(this),
                        i(".sticky-header .navigation-bar").css(
                            "padding-right",
                            ""
                    ...
                    switch (
                        ...
                        default:
                            n.hasClass("is-in-navbar") ||
                                ...
                                n.removeClass("is-in-mobile"),
                                n.insertAfter(
                                    t.parents(".navigation-bar__inner")
                                ));
                    }
                    n.hasClass("is-active") &&
                        setTimeout(function () {
        ...
        ajaxSearch: function () {
            ...
            var e = null,
                t = "",
                o = '<span class="noresult-text">There is no result.</span>',
                a = '<span class="error-text">There was some error.</span>';
            i(".js-ajax-search").each(function () {
                var e = i(this),
                    o = e.find(".search-form__input"),
                    a = e.find(".search-results"),
                    s = e.find(".search-results__inner"),
                    c = "",
                    r = "";
                o.on(
                    "input",
                    i.debounce(800, function () {
                        (c = o.val()),
                            c.length > 0
        ...
        loginForm: function () {
            i(".js-login-form-tabs")
                .find("a")
                .click(function (n) {
                    n.preventDefault(), i(this).tab("show");
                });
        },
        ...
        smartAffix: {
            ...
            onCheckpoint: 0,
            init: function (n) {
                (this.fixedHeader = n.fixedHeader),
                    (this.headerPlaceHolder = n.headerPlaceHolder),
                    i(this.fixedHeader).length &&
                        (i(document).ready(function () {
                            MINIMALDOG.header.smartAffix.compute();
                        }),
                        i(window).load(function () {
                            MINIMALDOG.header.smartAffix.compute(),
                                MINIMALDOG.header.smartAffix.updateState();
                        }));
            },
            compute: function () {
                i(this.headerPlaceHolder).length
                    ? (this.offCheckpoint =
                          i(this.headerPlaceHolder).offset().top + 400)
                    : (this.offCheckpoint = 400),
                    (this.onCheckpoint = this.offCheckpoint + 500),
                    (this.windowScrollTop = i(window).scrollTop()),
                    this.offCheckpoint < this.windowScrollTop &&
                        (this.isFixed = !0);
            },
            updateState: function () {
                this.isFixed
                    ? i(this.fixedHeader).addClass("is-fixed")
                    : (i(this.fixedHeader).removeClass("is-fixed"),
                      i(window).trigger("stickyHeaderHidden")),
                    this.isShown
                        ? i(this.fixedHeader).addClass("is-shown")
                        : i(this.fixedHeader).removeClass("is-shown");
            },
            eventScroll: function (i) {
                var n = "",
                    e = 0;
                i != this.lastWindowScrollTop &&
                    ((n = i > this.lastWindowScrollTop ? "down" : "up"),
                    (e = Math.abs(i - this.lastWindowScrollTop)),
                    (this.lastWindowScrollTop = i),
                    this.offCheckpoint < i
                        ? (this.isFixed = !0)
                        : (this.isFixed = !1),
                    this.isFixed
                        ? "down" == n && e > 14
        ...
        (MINIMALDOG.documentOnScroll = {
            ...
            goToTopScroll: function (i) {
                t.length &&
                    (i > 800
                        ? t.hasClass("is-active") || t.addClass("is-active")
            ...
            init: function () {
                window.addEventListener("resize", function (n) {
                    MINIMALDOG.documentOnResize.ticking ||
                        window.requestAnimationFrame(function () {
                            (MINIMALDOG.documentOnResize.windowScrollTop =
                                i(window).scrollTop()),
        ...
        (MINIMALDOG.documentOnReady = {
            ...
            ajaxLoadPost: function () {
                function n(n, t) {
                    ...
                    a.done(function (n) {
                        (e = i(n)),
                            ...
                            i("html, body")
                                .animate(
                                    { scrollTop: i(window).scrollTop() + 1 },
                                    0
                                )
                                .animate(
                                    { scrollTop: i(window).scrollTop() - 1 },
                ...
                i(".js-ajax-load-post").each(function () {
                    var e = i(this),
                        t = e.find(".posts-list"),
                        o = e.find(".js-ajax-load-post-trigger"),
                        a = {
                            offset: e.data("offset"),
                            postsToLoad: e.data("posts-to-load"),
            ...
            carousel_overlap: function () {
                ...
                n.each(function () {
                    var n = i(this);
                    n.flickity({ wrapAround: !0 }),
                        n.on("staticClick.flickity", function (i, e, t, o) {
                            "number" == typeof o &&
                                n.data("flickity").selectedIndex != o &&
                                n.flickity("selectCell", o);
                        });
                });
            },
            ...
            customCarouselNav: function () {
                if (i.isFunction(i.fn.owlCarousel)) {
                    ...
                    n.each(function () {
                        var n = i(this),
                            e = n
                                .parent(".mnmd-carousel-nav-custom-holder")
            ...
            countdown: function () {
                i.isFunction(i.fn.countdown) &&
                    i(".js-countdown").each(function () {
                        var n = i(this),
                            e = i(this).data("countdown");
                        n.countdown(e, function (n) {
                            i(this).html(
                                n.strftime(
            ...
            newsTicker: function () {
                ...
                n.each(function () {
                    var n = i(this),
                        e = n
                            .siblings(".mnmd-news-ticker__control")
                            .find(".mnmd-news-ticker__next"),
                        t = n
                            .siblings(".mnmd-news-ticker__control")
                            .find(".mnmd-news-ticker__prev");
                    n
                        ...
                        e.on("click", function () {
                            n.vTicker("next", { animate: !0 });
                        }),
                        t.on("click", function () {
                            n.vTicker("prev", { animate: !0 });
                        });
                });
            },
            lightBox: function () {
                i.isFunction(i.fn.magnificPopup) &&
                    ...
                    i(".js-mnmd-lightbox-gallery").each(function () {
            ...
            perfectScrollbarInit: function () {
                i.isFunction(i.fn.perfectScrollbar) &&
                    i(".js-perfect-scrollbar").perfectScrollbar({
                        wheelPropagation: !0,
                    });
            },
            stickySidebar: function () {
                setTimeout(function () {
                    var n = i(".js-sticky-sidebar"),
                        e = i(".js-sticky-header"),
                        t = e.length ? e.outerHeight() + 20 : 0;
                    i.isFunction(i.fn.theiaStickySidebar) &&
                        n.theiaStickySidebar({
    ...
    var n = i(window),
        e = i(document),
        t = i(".js-go-top-el");
    e.ready(MINIMALDOG.documentOnReady.init),
        n.load(MINIMALDOG.documentOnLoad.init),
        n.on("resize", MINIMALDOG.documentOnResize.init),
        (MINIMALDOG.clippedBackground = function () {
            var n = i(".js-overlay-bg");
            n.each(function () {
                var n = i(this).find(".js-overlay-bg-main-area");
                n.length || (n = i(this));
                var e = i(this).find(".js-overlay-bg-sub-area"),
                    t = i(this).find(".js-overlay-bg-sub");
                t.css("display", "block"),
                    t.css("position", "absolute"),
                    t.css("width", n.outerWidth() + "px"),
                    t.css("height", n.outerHeight() + "px");
                var o = n.offset().left - e.offset().left,
                    a = n.offset().top - e.offset().top;
        ...
        (MINIMALDOG.priorityNav = function (n) {
                ...
                if (0 != t[0].getBoundingClientRect().width) {
                    ...
                    if (
                        (t.children("li").each(function () {
                            e += i(this)[0].getBoundingClientRect().width;
                        }),
                        o)
                    ) {
                        var a = n.find(".priority-nav__more"),
                            s = a[0].getBoundingClientRect().width,
                            c = n[0].getBoundingClientRect().width;
                        if (
                            ((c -=
                                parseInt(n.css("padding-left")) +
                                parseInt(n.css("padding-right"))),
                            (c -= n.outerWidth(!1) - n.innerWidth()),
                            e > c)
                        ) {
                            var r = t.children("li:not(.priority-nav__more)"),
                                d = 1;
                            i(r.get().reverse()).each(function (n) {
                                return (
                                    (e -=
                                        i(this)[0].getBoundingClientRect()
                                            .width),
                                    e > c ? void d++ : !1
                                );
                            });
                            ...
                            l.each(function (n) {
                                i(this).attr(
                                    "data-width",
                                    i(this)[0].getBoundingClientRect().width
                                );
                            }),
                                l.prependTo(a.children("ul"));
                        } else {
                            var u = a.children("ul").children("li"),
                                m = 0;
                            if (
                                (1 == u.length
                                    ? c >= e - s + u.first().data("width") &&
                                      (m = 1)
                                    : u.each(function (n) {
                                          return (
                                              (e += i(this).data("width")),
                                ...
                                var f = u.slice(0, m);
                                f.insertBefore(
                                    t.children(".priority-nav__more")
                                ),
                                    (u = a.children("ul").children("li")),
                                    u.length <= 0 && (a.remove(), (o = !1));
                            }
                        }
                    } else {
                        var a = i(
            ...
            var t = (n.find("button"), n.find(".navigation")),
                o = !1;
            t.length &&
                (i(window).on("load", e),
                i(window).on("webfontLoaded", e),
                i(window).on("resize", i.throttle(100, e)));
        });
})(jQuery);
