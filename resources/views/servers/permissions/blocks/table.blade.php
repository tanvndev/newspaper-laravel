        ...
        @foreach ($permissions as $permission) <tr>
            ...
            <td>
                <div class="btn-group" role="group">
                    <a href="{{route('permissions.edit', $permission->id)}}" class="btn btn-outline-secondary"><i
...
@include('servers.includes.modalDelete', ['routeModalDelete' => 'permissions.destroy'])