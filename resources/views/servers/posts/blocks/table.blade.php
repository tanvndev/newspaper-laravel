    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <a href="{{route('posts.index', ['post_catalogue_id' => $catalogue->id])}}"
            ...
            <td>
                <div class="btn-group" role="group">
                    <a href="{{route('posts.edit', $post->id)}}" class="btn btn-outline-secondary"><i
...
@include('servers.includes.modalDelete', ['routeModalDelete' => 'posts.destroy'])